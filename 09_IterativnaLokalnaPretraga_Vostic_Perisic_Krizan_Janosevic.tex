...
\\Grafička ilustracija problema je izložena na slici \ref{figure:fsp}.
\begin{figure}[h!]
  \centering
...
\\Na slici \ref{figure:jssp} je predstavljena grafička ilustracija problema.
\begin{figure}[h!]
  \centering
...
Svi algoritmi su implementirani pod istim uslovima i pokretani na istoj mašini: programirani su na jeziku Delphi 6.0, pokretani na Athlon XP 1600+ (1400MHz) koriščenjem 512 MBajta RAM memorije. 
