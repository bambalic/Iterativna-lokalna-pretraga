...
ILS se takođe može uspešno primeniti i na probleme raspoređivanja kao što su \textbf{problem rasporeda na jednoj mašini pomoću ukupnog ponderisanog kašnjenja} \eng{single machine total weighted tardiness problem} tj. SMTWTP,  \textbf{problem rasporeda n proizvoda na m mašina} \eng{flow shop problem} tj. FSP, \textbf{problem raspoređivanja poslova} \eng{job shop scheduling problem} tj. JSSP
